"""Pre-flight validation for ``HaijunAgentOptions.session_store`` combinations."""

from __future__ import annotations

from ..types import HaijunAgentOptions, SessionStore
...
def validate_session_store_options(options: HaijunAgentOptions) -> None:
