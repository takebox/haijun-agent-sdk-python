"""Error types for Haijun SDK."""

from typing import Any


class HaijunSDKError(Exception):
    """Base exception for all Haijun SDK errors."""


class CLIConnectionError(HaijunSDKError):
    """Raised when unable to connect to Haijun Code."""


class CLINotFoundError(CLIConnectionError):
    """Raised when Haijun Code is not found or not installed."""

    def __init__(
        self, message: str = "Haijun Code not found", cli_path: str | None = None
    ):
        if cli_path:
...
class ProcessError(HaijunSDKError):
...
class CLIJSONDecodeError(HaijunSDKError):
...
class MessageParseError(HaijunSDKError):
