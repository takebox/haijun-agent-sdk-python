"""Query function for one-shot interactions with Haijun Code."""
...
from .types import HaijunAgentOptions, Message
...
async def query(
    *,
    ...
    """
    Query Haijun Code for one-shot or unidirectional streaming interactions.

    This function is ideal for simple, stateless queries where you don't need
    bidirectional communication or conversation management. For interactive,
    stateful conversations, use HaijunSDKClient instead.

    Key differences from HaijunSDKClient:
    ...
    Args:
        prompt: The prompt to send to Haijun. Can be a string for single-shot queries
        ...
        options: Optional configuration (defaults to HaijunAgentOptions() if None).
    ...
    Example - With custom transport:
        ```python
        from haijun_agent_sdk import query, Transport
