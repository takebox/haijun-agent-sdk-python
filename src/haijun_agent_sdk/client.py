"""Haijun SDK Client for interacting with Haijun Code."""
...
class HaijunSDKClient:
    """
    Client for bidirectional, interactive conversations with Haijun Code.
    ...
    When to use HaijunSDKClient:
    - Building chat interfaces or conversational UIs
    - Interactive debugging or exploration sessions
    - Multi-turn conversations with context
    - When you need to react to Haijun's responses
    ...
    See examples/streaming_mode.py for full examples of HaijunSDKClient in
    different scenarios.

    Caveat: As of v0.0.20, you cannot use a HaijunSDKClient instance across
    ...
    def __init__(
        self,
        options: HaijunAgentOptions | None = None,
        transport: Transport | None = None,
    ):
        """Initialize Haijun SDK client."""
        if options is None:
    ...
    async def connect(
        ...
        """Connect to Haijun with a prompt or message stream."""
        ...
        # into a temp HAIJUN_CONFIG_DIR for the subprocess to resume from.
        ...
        try:
            ...
            # removing the temp HAIJUN_CONFIG_DIR it points at. disconnect()
    ...
    async def _connect_inner(
        ...
        # Calculate initialize timeout from HAIJUN_CODE_STREAM_CLOSE_TIMEOUT env var if set
        # HAIJUN_CODE_STREAM_CLOSE_TIMEOUT is in milliseconds, convert to seconds
        initialize_timeout_ms = int(
            os.environ.get("HAIJUN_CODE_STREAM_CLOSE_TIMEOUT", "60000")
        )
        ...
        self._query = Query(
            ...
            is_streaming_mode=True,  # HaijunSDKClient always uses streaming mode
    ...
    async def receive_messages(self) -> AsyncIterator[Message]:
        """Receive all messages from Haijun."""
        if not self._query:
    ...
    async def set_model(self, model: str | None = None) -> None:
        ...
        Args:
            model: The model to use, or None to use default. Examples:
                - 'haijun-sonnet-5'
                - 'haijun-opus-1-20250805'
                - 'haijun-opus-20250514'
        ...
        Example:
            ...
            async with HaijunSDKClient() as client:
                ...
                await client.set_model('haijun-sonnet-5')
    ...
    async def get_mcp_status(self) -> McpStatusResponse:
        ...
        Queries the Haijun Code CLI for the live connection status of all
        ...
        Returns:
            ...
            - 'config': Server configuration (stdio/sse/http/sdk/haijunai-proxy)
    ...
    async def get_context_usage(self) -> ContextUsageResponse:
        ...
        Returns:
            ...
            - 'memoryFiles': Per-file token breakdown for HAIJUN.md files
    ...
    async def get_server_info(self) -> dict[str, Any] | None:
        ...
        Returns initialization information from the Haijun Code server including:
    ...
    async def receive_response(self) -> AsyncIterator[Message]:
        """
        Receive messages from Haijun until and including a ResultMessage.
    ...
    async def __aenter__(self) -> "HaijunSDKClient":
