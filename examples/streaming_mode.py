#!/usr/bin/env python3
"""
Comprehensive examples of using HaijunSDKClient for streaming mode.

This file demonstrates various patterns for building applications with
the HaijunSDKClient streaming interface.
...
def display_message(msg):
    ...
    - AssistantMessage: "Haijun: <content>"
...
async def example_with_options():
    """Use HaijunAgentOptions to configure the client."""
