#!/usr/bin/env python
"""Example of using hooks with Haijun Code SDK via HaijunAgentOptions.

This file demonstrates various hook patterns using the hooks parameter
in HaijunAgentOptions instead of decorator-based hooks.
...
async def example_pretooluse() -> None:
    ...
    # Configure hooks using HaijunAgentOptions
...
if __name__ == "__main__":
    print("Starting Haijun SDK Hooks Examples...")
    print("=" * 50 + "\n")
    asyncio.run(main())
