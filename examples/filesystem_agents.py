...
This example demonstrates how to load agents defined in .haijun/agents/ files
...
async def main():
    ...
    print("Testing: setting_sources=['project'] with .haijun/agents/test-agent.md")
    print()

    # Use the SDK repo directory which has .haijun/agents/test-agent.md
    ...
    if has_test_agent:
        ...
        print("WARNING: test-agent was NOT loaded (may not exist in .haijun/agents/)")
