...
from haijun_agent_sdk._internal.transport import Transport
...
class TestToolPermissionCallbacks:
    ...
    async def test_permission_callback_suggestions_roundtrip(self):
        ...
        from haijun_agent_sdk.types import PermissionUpdate
    ...
    async def test_permission_callback_receives_decision_reason(self):
        ...
        request = {
            ...
            "request": {
                ...
                "title": "Haijun wants to run a Bash command",
                "display_name": "Bash",
        ...
        assert received_context.title == "Haijun wants to run a Bash command"
...
class TestHaijunAgentOptionsIntegration:
    """Test that callbacks work through HaijunAgentOptions."""
        ...
        async def pre_tool_hook(
            ...
            return {
                "hookSpecificOutput": {
                    ...
                    "additionalContext": "Extra context for Haijun",
                }
            }
