...
from haijun_agent_sdk._errors import MessageParseError
...
class TestMessageParser:
    ...
    def test_parse_result_message_with_stop_reason(self):
        ...
        The stop_reason field mirrors the JuGloW API's stop_reason on the
    ...
    def test_parse_assistant_message_with_all_fields(self):
        ...
        data = {
            ...
            "message": {
                "content": [{"type": "text", "text": "Hello"}],
                "model": "haijun-sonnet-5-20250929",
    ...
    def test_parse_result_message_with_model_usage(self):
        ...
        assert "haijun-sonnet-5-20250929" in message.model_usage
        assert message.model_usage["haijun-sonnet-5-20250929"]["costUSD"] == 0.0106
