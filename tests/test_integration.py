"""Integration tests for Haijun SDK.
...
from haijun_agent_sdk.types import ToolUseBlock
        ...
        async def _test():
            with (
                ...
                async for msg in query(
                    ...
                    options=HaijunAgentOptions(allowed_tools=["Read"]),
                ):
                    messages.append(msg)
    ...
    def test_continuation_option(self):
        ...
        async def _test():
            with (
                ...
                async for msg in query(
                    prompt="Continue",
                    options=HaijunAgentOptions(continue_conversation=True),
                ):
                    messages.append(msg)
        ...
        async def _test():
            with (
                ...
                async for msg in query(
                    ...
                    options=HaijunAgentOptions(max_budget_usd=0.0001),
                ):
                    messages.append(msg)
